...
public class Torque_Control : MonoBehaviour
{
    ...
    void find_F()
    {
        ...
        var coeffs_Ddr_Shoulder = NMC.FFD_Coeffs_Ddl_Shoulder(alpha_Body, beta_Body, dalpha_Body, dbeta_Body, depth_Body, dgamma_Body, g, gamma_Body, height_Body, l_Alpha_Hand, l_Tau_Beta_Shoulder, l_Tau_Alpha_Shoulder, m_Body, r_Beta_Hand, r_Tau_Beta_Shoulder, r_Tau_Alpha_Shoulder, width_Body);
        var coeffs_Ddl_Shoulder = NMC.FFD_Coeffs_Ddr_Shoulder(alpha_Body, beta_Body, dalpha_Body, dbeta_Body, depth_Body, dgamma_Body, g, gamma_Body, height_Body, l_Alpha_Hand, l_Tau_Beta_Shoulder, l_Tau_Alpha_Shoulder, m_Body, r_Beta_Hand, r_Tau_Beta_Shoulder, r_Tau_Alpha_Shoulder, width_Body);
    ...
    void find_F_Spring()
    {
        ...
        var dr_Shoulder = NMC.FRD_Dr_Shoulder(alpha_Body, beta_Body, dalpha_Body, dbeta_Body, dgamma_Body, dx_Head, dy_Head, dz_Head, gamma_Body, width_Body);
        var dl_Shoulder = NMC.FRD_Dl_Shoulder(alpha_Body, beta_Body, dalpha_Body, dbeta_Body, dgamma_Body, dx_Head, dy_Head, dz_Head, gamma_Body, width_Body);

        var dl_Arm_Bottom = NMC.FRD_Dl_Arm_Bottom(dl_Beta_Hand, dl_Alpha_Hand, l_Alpha_Hand, l_Beta_Hand, length_Hand);
        var dr_Arm_Bottom = NMC.FRD_Dr_Arm_Bottom(dr_Beta_Hand, dr_Alpha_Hand, length_Hand, r_Alpha_Hand, r_Beta_Hand);
    ...
    void subs_Deltas()
    {
        ...
        var dds_Body = NMC.FFD_Dds_Body(alpha_Body, beta_Body, dalpha_Body, depth_Body, dgamma_Body, g, gamma_Body, height_Body, l_Alpha_Hand, l_F_X, l_F_Y, l_F_Z, l_Tau_Beta_Shoulder, l_Tau_Alpha_Shoulder, m_Body, r_Beta_Hand, r_F_X, r_F_Y, r_F_Z, r_Tau_Beta_Shoulder, r_Tau_Alpha_Shoulder, width_Body);
