...
unit_Vector_L = coeffs_Vector(omega_L_Tmp, [dl_Alpha_Hand, dl_Beta_Hand]);
...
coeffs_Tau_L_Alpha = unit_Vector_L(:,1)' * l_Tau_Vec;
coeffs_Tau_L_Beta = unit_Vector_L(:,2)' * l_Tau_Vec;
